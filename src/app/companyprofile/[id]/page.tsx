...
// import { fetchStartupById, updateStartup } from "@/app/redux/features/companyprofile/companyProfileSlice";
...
//   const handleSubmit = () => {
//     dispatch(updateStartup({ id: decodedOrganizationId, data: formData }))
//       .then(() => {
//         setIsEditing(false);
