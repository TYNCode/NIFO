...
import { setProjectID, setSelectedTab, fetchProjectDetails } from "../../redux/features/coinnovation/projectSlice";
...
const ProjectSummaryPage = ({ params }: { params: { id: string } }) => {
    ...
    const { projectID, selectedTab, projectDetails, fetching, error } = useAppSelector((state) => state.projects);
