...
const CompanyProfilePage: React.FC = () => {
  ...
  const companies = useAppSelector(
    (state) => state.companyProfile.companiesList
  );
  ...
  const searchResults = useAppSelector(
    (state) => state.companyProfile.searchResults
  );
  const searchSuggestResults = useAppSelector(
    (state) => state.companyProfile.searchSuggestResults
  );
        ...
        <div className="w-full flex justify-around h-fit flex-col">
          <div className="flex sm:w-[70%] w-[90%] mx-auto my-0 flex-col">
            <div className="flex sm:flex-row flex-col gap-3">
              ...
              />
              <Button
                className="bg-[#4dabf7] hover:!bg-[#228be6] focus:!outline-none"
                onClick={() => handleSearchCompanies(searchTerm)}
              >
                Search
              </Button>
            </div>
